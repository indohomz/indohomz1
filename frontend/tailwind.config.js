...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Premium Stone palette - warm, calm, sophisticated
        stone: {
          50: '#FAFAF9',
          100: '#F5F5F4',
          200: '#E7E5E4',
        ...
        // Brand primary (blue) & accent (purple) - legacy support
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      fontSize: {
        ...
        'display-2xl': ['clamp(3rem, 8vw, 6rem)', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
